...
class col_s11 extends SpyropressBuilderColumn {
    ...
    public function __construct() {
        ...
        $this->config = array(
            'name' => __( '11ColumnSize', 'spyropress' ),
            'description' => __( '11th column of grid.', 'spyropress' ),
            'icon' => get_panel_img_path( 'layouts/col_56.png' ),
            'size' => 11
        );
    }
...
class col_s7 extends SpyropressBuilderColumn {
    ...
    public function __construct() {
        ...
        $this->config = array(
            'name' => __( '7 ColumnSize', 'spyropress' ),
            'description' => __( '7 column of grid.', 'spyropress' ),
            'icon' => get_panel_img_path( 'layouts/col_56.png' ),
            'size' => 7
        );
    }
...
class col_s5 extends SpyropressBuilderColumn {
    ...
    public function __construct() {
        ...
        $this->config = array(
            'name' => __( '5 ColumnSize', 'spyropress' ),
            'description' => __( '5 column of grid.', 'spyropress' ),
            'icon' => get_panel_img_path( 'layouts/col_56.png' ),
            'size' => 5
        );
    }
...
class col_s1 extends SpyropressBuilderColumn {
    ...
    public function __construct() {
        ...
        $this->config = array(
            'name' => __( '1 ColumnSize', 'spyropress' ),
