    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="span2 sidebar">
    				...
    				<hr />
                    <?php the_terms( 0, 'portfolio_category', '<dl><dt>Categories</dt><dd>', ', ', '</dd></dl>' ); ?>
                    <?php the_terms( 0, 'portfolio_tag', '<dl><dt>Tags</dt><dd>', ', ', '</dd></dl>' ); ?>	
    			</div>
    			<div class="span8">
                    <div class="post-content">
                        <?php get_image( 'width=9999&class=margin&before=<div class="text-center">&after=</div>' ); ?>
